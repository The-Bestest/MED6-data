...
predictOrdinal <- function(formula, dataset, predictedVar) {
  ...
  res <- list(
    ...
    "misclassificationRate" = mean(as.character(predictedVar) != as.character(predictVariable))
  )
...
cor.test(Discrete$Frustration, Discrete$ObjectiveSuccesses, method="spearman", exact = FALSE)
cor.test(Continuous$Frustration, Continuous$ObjectiveSuccesses, method="spearman", exact = FALSE)
...
plotCorrelation(gameSummary, gameSummary$Frustration, gameSummary$PerceivedSuccesses, "Frustration",  "PerceivedSuccesses")
